...
pub mod change {
    ...
    pub enum Change {
        ...
        #[prost(message, tag="13")]
        UpdateTeamStateChange(#[allow(clippy::large_enum_variant)]Box<UpdateTeamState>),
        #[prost(message, tag="14")]
...
impl SslSource {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Grim => "SSL_SOURCE_GRSIM",
            Self::EnforceSim => "SSL_SOURCE_ERFORCE_SIM",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> Option<Self> {
        match value {
            ...
            "SSL_SOURCE_GRSIM" => Some(Self::Grim),
            "SSL_SOURCE_ERFORCE_SIM" => Some(Self::EnforceSim),
            _ => None,
        }
    }
}
